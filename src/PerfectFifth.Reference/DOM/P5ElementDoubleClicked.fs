module P5Reference.DOM.P5ElementDoubleClicked
...
let setup p5 =
    ...
    cnv'.doubleClicked (changeGray) // attach listener for canvas double click only
    10.0
...
let onDoubleClicked _ _ d = d + 10.0
